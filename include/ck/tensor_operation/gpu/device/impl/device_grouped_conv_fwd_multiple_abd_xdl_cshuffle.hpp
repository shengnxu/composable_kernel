                                             ...
                                             BComputeDataType>
{
    ...
    static constexpr auto conv_ngchw_to_nhwgc_transformer =
        TransformConvNGCHWToNHWGC<NDimSpatial,
...
#define GridwiseGemmTemplateParameters                                                          \
    ...
    static constexpr index_t TransposeTransferSrcScalarPerVector = 1;
    static constexpr index_t TransposeTransferDstScalarPerVector = 1;
    ...
    struct Argument : public BaseArgument
    {
        Argument(APointers p_as,
            ...
            : p_as_grid_{},
              ...
              a_g_n_c_wis_strides_{TransposeStrides(a_g_n_c_wis_lengths, a_g_n_c_wis_strides)},
              b_g_k_c_xs_lengths_{b_g_k_c_xs_lengths},
              b_g_k_c_xs_strides_{b_g_k_c_xs_strides},
              ds_g_n_k_wos_lengths_{ds_g_n_k_wos_lengths},
              ds_g_n_k_wos_strides_{ds_g_n_k_wos_strides},
              e_g_n_k_wos_lengths_{e_g_n_k_wos_lengths},
              e_g_n_k_wos_strides_{TransposeStrides(e_g_n_k_wos_lengths, e_g_n_k_wos_strides)},
    ...
    struct Invoker : public BaseInvoker
    {
        ...
        float Run(const Argument& arg, const StreamConfig& stream_config = StreamConfig{})
        {
                         ...
                         is_NGCDHW_GKZYXC_NGKDHW<ALayout, BLayout, ELayout>())
            {
                ...
                EDataType* p_e_out_grid = type_convert<EDataType*>(arg.p_workspace_) +
                                          arg.GetWorkspaceATensorSizeBytes() / sizeof(EDataType);

                const EDataType* p_e_in_grid = arg.p_e_grid_;
...
printf("XX0\n");
        ...
        if constexpr(is_NGCHW_GKYXC_NGKHW<ALayout, BLayout, ELayout>() ||
                     is_NGCDHW_GKZYXC_NGKDHW<ALayout, BLayout, ELayout>())
        {
            if((G * C) % TransposeTransferDstScalarPerVector != 0)
            {
                return false;
            }

            if((G * K) % TransposeTransferSrcScalarPerVector != 0)
            {
                return false;
            }
            ...
            if(output_spatial_acum % TransposeTransferDstScalarPerVector != 0)
            {
                return false;
            }
        }
