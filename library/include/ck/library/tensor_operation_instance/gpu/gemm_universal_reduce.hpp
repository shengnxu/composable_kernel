...
void add_device_gemm_xdl_universal_reduce_bf16_bf16_bf16_mk_nk_mn_comp_default_instances(
    std::vector<std::unique_ptr<DeviceGemmV2R1<Row,
                                               Col,
                                               DsLayout,
                                               Row,
...
void add_device_gemm_xdl_universal_reduce_bf16_bf16_bf16_mk_nk_mn_comp_kpadding_instances(
    std::vector<std::unique_ptr<DeviceGemmV2R1<Row,
                                               Col,
                                               DsLayout,
                                               Row,
                                               ...
                                               PassThrough,
                                               PassThrough>>>& instances);
void add_device_gemm_xdl_universal_reduce_bf16_bf16_bf16_mk_nk_mn_comp_mnpadding_instances(
    std::vector<std::unique_ptr<DeviceGemmV2R1<Row,
                                               Col,
                                               DsLayout,
                                               Row,
                                               ...
                                               PassThrough,
                                               PassThrough>>>& instances);
void add_device_gemm_xdl_universal_reduce_bf16_bf16_bf16_mk_nk_mn_comp_mnkpadding_instances(
    std::vector<std::unique_ptr<DeviceGemmV2R1<Row,
                                               Col,
                                               DsLayout,
                                               Row,
...
void add_device_gemm_xdl_universal_reduce_f8_f8_bf16_mk_nk_mn_comp_default_instances(
    std::vector<std::unique_ptr<DeviceGemmV2R1<Row,
                                               Col,
                                               DsLayout,
                                               Row,
...
void add_device_gemm_xdl_universal_reduce_f8_f8_bf16_mk_nk_mn_comp_kpadding_instances(
    std::vector<std::unique_ptr<DeviceGemmV2R1<Row,
                                               Col,
                                               DsLayout,
                                               Row,
...
void add_device_gemm_xdl_universal_reduce_f8_f8_bf16_mk_nk_mn_comp_mnpadding_instances(
    std::vector<std::unique_ptr<DeviceGemmV2R1<Row,
                                               ...
                                               PassThrough,
                                               PassThrough>>>& instances);
void add_device_gemm_xdl_universal_reduce_f8_f8_bf16_mk_nk_mn_comp_mnkpadding_instances(
    std::vector<std::unique_ptr<DeviceGemmV2R1<Row,
                                               Col,
                                               DsLayout,
                                               Row,
