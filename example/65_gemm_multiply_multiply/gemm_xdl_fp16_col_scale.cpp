...
using DeviceOpInstance = ck::tensor_operation::device::DeviceGemmMultiD_Xdl_CShuffle_V3
    // clang-format off
         <A0Layout, B0Layout, DsLayout, ELayout,
          ...
          AElementOp,  BElementOp, CDEElementOp, GemmSpec, 64,
          16, 16, 64,
          8,  4,
          16, 16,
          1,  1,
          S<8, 8, 1>,  S<1, 0, 2>, S<1, 0, 2>, 2, 8, 8, 0,
          S<16, 4, 1>,  S<0, 2, 1>, S<0, 2, 1>, 1, 4, 4, 0,
          1, 1, S<1, 16, 1, 2>, S<8, 1>,
...
int main(int argc, char* argv[])
{
    ...
    auto cde_element_op = CDEElementOp{2.0, 1.0};
    ...
    auto argument =
        device_op.MakeArgument(a0_device_buf.GetDeviceBuffer(),
                               ...
                               StrideA,
                               StrideB,
                               std::array<ck::index_t, NumDTensor>{I0},
                               StrideE,
                               a_element_op,
                               b_element_op,
                               cde_element_op);
